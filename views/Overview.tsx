...
import { IMAGES, formatTime, SHIPS } from '../constants';
import { ShipId } from '../types';

const Overview: React.FC<{ onNavigate: (view: string) => void }> = ({ onNavigate }) => {
    const { constructionQueue, buildings, ships, shipyardQueue, planetName, renamePlanet } = useGame();
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-5 xl:col-span-4">
                    <div className="bg-[#1c2136] rounded-xl border border-white/10 overflow-hidden h-full shadow-2xl">
                        <div className="relative h-64 bg-cover bg-center group" style={{ backgroundImage: `url("${IMAGES.planet}")` }}>
