              ...
              <div className="p-6 flex items-center justify-between border-b border-white/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-white text-lg font-bold tracking-tight uppercase">StarCommand</h1>
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-[#1c2136]/95 backdrop-blur-md border-t border-white/10 z-50 pb-safe">
          <div className="flex justify-around items-center h-16 px-1">
                  ...
                  return (
                      <button
                          ...
                          className={`flex flex-col items-center justify-center w-full h-full gap-1 transition-colors ${
                              isActive ? 'text-primary' : 'text-[#929bc9] hover:text-white'
                          }`}
                      >
              ...
              <button
                  ...
                  className={`flex flex-col items-center justify-center w-full h-full gap-1 transition-colors ${
                      isMenuOpen ? 'text-white' : 'text-[#929bc9] hover:text-white'
                  }`}
              >
